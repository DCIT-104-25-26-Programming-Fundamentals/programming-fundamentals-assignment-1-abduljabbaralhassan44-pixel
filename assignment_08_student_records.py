...
def add_student(students):
    """
    Prompts for student details, reads scores into a list,
    and appends a dictionary record to students.
    """
...
def display_all_students(students):
    """Prints a formatted table of all student records with calculated averages."""
    if not students:
    ...
    for s in students:
        ...
        print(f"{s['name']:<20} {s['id']:<12} {scores_str:<15} {avg:.2f}")
...
def display_menu():
    """Prints the main system menu options."""
    print("\n================================")
